...
enum DataErrors
{
    ...
    TOO_MANY_SYMBOLS, //!< слишком много токенов, что не соответствует шаблону

    WRONG_INPUT, //!< несоответствие токенов нужному шаблону

    NO_INT //!< в нужных токенах не целочисленные значения
};
